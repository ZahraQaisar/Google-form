...
//   // 2️⃣ Update context (used by Preview)
//   setQuestions("Bug Report", [
//     ...(formQuestions["Bug Report"] || []),
//     newQuestion,
//   ]);
// }}
...
//               {/* Mount template logic */}
//               {selectedTemplate === "Bug Report" && (
//   <BugReportTemplate setForms={setForms} />
// )}


//               {/* Previews (no change here yet) */}
//               {showPreview && (
//                 <>
...
const App = () => (
  <Routes>
    <Route path="/signup" element={<Signup />} />
    <Route path="/login" element={<Login />} />
    <Route path="/" element={<FormProvider><AppContent /></FormProvider>} />
  </Routes>
);
